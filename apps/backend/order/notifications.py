...
from accounts.models import StaffNotificationRecipient
...
from graphq.core.utils import to_global_id_or_none
...
def get_attribute_data_from_order_lines(lines: Iterable["OrderLine"]) -> AttributeData:
    ...
    attribute_values_map = AttributeValue.objects.in_bulk(attribute_value_ids)

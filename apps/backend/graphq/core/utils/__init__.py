...
def from_global_id_or_none(global_id, only_type: Union[ObjectType, str, None] = None, raise_error: bool = False):
    if not global_id:
        return None
...
def to_global_id_or_none(instance):class_name = instance.__class__.__name__

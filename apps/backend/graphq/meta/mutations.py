...
class BaseMetadataMutation(relay.ClientIDMutation):
    class Meta:
        abstract = True
...
class DeleteMetadata(relay.ClientIDMutation):
    class Meta:
        description = (
...
class UpdatePrivateMetadata(relay.ClientIDMutation):
    class Meta:
        description = (
...
class DeletePrivateMetadata(relay.ClientIDMutation):
    class Meta:
        description = (

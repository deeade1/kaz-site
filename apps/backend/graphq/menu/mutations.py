...
class MenuCreate(relay.ClientIDMutation):
    class Input:
...
class MenuUpdate(relay.ClientIDMutation):
    class Input:
...
class MenuDelete(relay.ClientIDMutation):
    class Input:
...
class MenuItemCreate(relay.ClientIDMutation):
    class Input:
...
class MenuItemUpdate(relay.ClientIDMutation):
    class Input:
...
class MenuItemDelete(relay.ClientIDMutation):
    class Input:
...
class MenuItemMove(relay.ClientIDMutation):
...
class AssignNavigation(relay.ClientIDMutation):

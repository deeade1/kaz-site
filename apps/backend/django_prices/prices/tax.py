...
@overload
def flat_tax(
    base: Union[Money, TaxedMoney], tax_rate: Decimal, *, keep_gross
) -> TaxedMoney: ...  # pragma: no cover


@overload
def flat_tax(
    base: Union[MoneyRange, TaxedMoneyRange], tax_rate: Decimal, *, keep_gross
) -> TaxedMoneyRange: ...  # pragma: no cover

...
def get_channel_to_products_map_from_rules(
    ...
    rules_qs = rules
    if allow_replica:
        rules_qs = rules.product_variant_qs = product_variant_qs
        promotion_rule_qs = promotion_rule_qs
        promotion_rule_channel_qs = promotion_rule_channel_qs
...
def mark_products_in_channels_as_dirty(
    ...
    if allow_replica:
        product_channel_listings_qs = product_channel_listings_qs

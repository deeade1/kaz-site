...
class Payment(ModelWithMetadata):
    ...
    class Meta:
        ...
        indexes = [
            *ModelWithMetadata.Meta.indexes,  # Preserve inherited indexes
            # Orders filtering by status index using BTreeIndex
            BTreeIndex(fields=["order_id"], name="order_id_btree_idx"),
            BTreeIndex(fields=["is_active"], name="is_active_btree_idx"),
            BTreeIndex(fields=["charge_status"], name="charge_status_btree_idx"),
        ]
    ...
    class Meta:
        ...
        indexes = [
            GinIndex(
                name="token_idx",
                fields=["token"],
                opclasses=["gin_trgm_ops"],  # Specify the GIN operator class
            ),
        ]

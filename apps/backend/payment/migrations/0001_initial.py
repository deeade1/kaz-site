    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=django.contrib.postgres.indexes.BTreeIndex(
                fields=["order_id"], name="order_id_btree_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="payment",
            index=django.contrib.postgres.indexes.BTreeIndex(
                fields=["is_active"], name="is_active_btree_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="payment",
            index=django.contrib.postgres.indexes.BTreeIndex(
                fields=["charge_status"], name="charge_status_btree_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="transaction",
            index=django.contrib.postgres.indexes.GinIndex(
                fields=["token"], name="token_idx", opclasses=["gin_trgm_ops"]
            ),
        ),
        migrations.AddIndex(
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("idempotency_key",), name="unique_transaction_idempotency"
            ),
        ),
        migrations.AddConstraint(

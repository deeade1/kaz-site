...
class DeprecatedStripeGatewayPlugin(BasePlugin):
    ...
    PLUGIN_DESCRIPTION = """
    This plugin will be removed in  Use the new Stripe plugin which
    ...
    CONFIG_STRUCTURE = {
        ...
        "Store customers card": {
            ...
            "help_text": "Determines if  should store cards on payments "
            "in Stripe customer.",
            "label": "Store customers card",
        },
        "Automatic payment capture": {
            "type": ConfigurationTypeField.BOOLEAN,
            "help_text": "Determines if  should automatically capture payments.",

...
IMAGES_MAPPING = {
    126: ["kaz-headless-omnichannel-book.png"],
    127: [
        "kaz-white-plimsolls-1.png",
        "kaz-white-plimsolls-2.png",
        "kaz-white-plimsolls-3.png",
        "kaz-white-plimsolls-4.png",
    ],
    128: [
        "kaz-blue-plimsolls-1.png",
        "kaz-blue-plimsolls-2.png",
        "kaz-blue-plimsolls-3.png",
        "kaz-blue-plimsolls-4.png",
    ],
    129: ["kaz-dash-force-1.png", "kaz-dash-force-2.png"],
    130: ["kaz-pauls-blanace-420-1.png", "kaz-pauls-blanace-420-2.png"],
    131: ["kaz-grey-hoodie.png"],
    132: ["kaz-blue-hoodie.png"],
    133: ["kaz-white-hoodie.png"],
    134: ["saleor-ascii-shirt-front.png", "saleo-ascii-shirt-back.png"],
...
def get_sample_data():
    path = os.path.join(
        settings.PROJECT_ROOT, "backend", "static", "populatedb_data.json"
    )
...
# fake customers.
@patch("plugins.manager.PluginsManager.notify")

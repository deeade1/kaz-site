...
from graphq.account.dataloaders import UserByEmailLoader
from graphq.plugins.dataloaders import AnonymousPluginManagerLoader
...
def load_user_from_request(request):
    ...
    if not jwt_token or not is_token(jwt_token):
        return None

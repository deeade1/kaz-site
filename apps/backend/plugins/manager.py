...
if TYPE_CHECKING:
    ...
    from accounts.models import Address, Group, User
...
class PluginsManager(PaymentInterface):
    ...
    def webhook_endpoint_without_channel(self, plugin_id: str) -> HttpResponse:
    ...
    def webhook(self, plugin_id: str, channel_slug: Optional[str]) -> HttpResponse:
        split_path = request.path.split(plugin_id, maxsplit=1)
        path = None
        if len(split_path) == 2:
            path = split_path[1]
    ...
    def external_authentication_url(self, plugin_id: str, data: dict) -> dict:
    ...
    def external_refresh(self, plugin_id: str, data: dict) -> ExternalAccessTokens:
    ...
    def external_logout(self, plugin_id: str, data: dict) -> dict:
        """Logout the user."""

...
from accounts.utils import retrieve_user_by_email, store_user_address
...
from graphq.checkout.utils import prepare_insufficient_stock_checkout_validation_error
...
def _create_order(
    *,
    ...
    add_gift_cards_to_order(checkout_info, order, total_price_left, user)

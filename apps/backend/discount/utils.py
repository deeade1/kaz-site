...
def fetch_collections(
    ...
    collections = Sale.collections.through.objects.filter(sale_id__in=sale_pks)
...
def fetch_products(
    ...
    product_qs = Sale.products.through.objects.filter(sale_id__in=sale_pks)
...
def fetch_variants(
    ...
    variant_qs = Sale.variants.through.objects.filter(sale_id__in=sale_pks)

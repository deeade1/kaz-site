const Aside = memo(() => {
    return (
    <>
    <aside class="sidebar sidebar-base sidebar-white left-bordered" data-toggle="main-sidebar" data-sidebar="responsive">
         ...
         <div class="sidebar-body pt-0 data-scrollbar" data-scrollbar="true" tabindex="-1" style="overflow: hidden; outline: none;">
            ...
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="iq-social-app">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " aria-current="page" href="../social-app/index.html">
                            <i class="icon">
                    ...
                    <li class="nav-item">
                     ...
                     <li class="nav-item active">
                        ...
                        <ul class="sub-nav collapse show" id="profile" data-bs-parent="#iq-social-app" style="">
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                             ...
                             <li class="nav-item">
                                <a class="nav-link active" href="../social-app/account-setting.html">
                                    <i class="icon">
                                        <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                     ...
                     <li class="nav-item">
                        <a class="nav-link collapsed" data-bs-toggle="collapse" href="#event" role="button" aria-expanded="false" aria-controls="event">
                            <i class="icon">
                                <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                     ...
                     <li class="nav-item">
                        <a class="nav-link collapsed" data-bs-toggle="collapse" href="#group" role="button" aria-expanded="false" aria-controls="group">
                            <i class="icon">
                                <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="scrollbar-track scrollbar-track-x" style="display: none;">
            <div class="scrollbar-thumb scrollbar-thumb-x" style="width: 227px; transform: translate3d(0px, 0px, 0px);">
                </div>
                </div>
                <div class="scrollbar-track scrollbar-track-y" style="display: block;">
                    <div class="scrollbar-thumb scrollbar-thumb-y" style="height: 163.325px; transform: translate3d(0px, 0px, 0px);">
                        </div>
                        </div>
                    </div>

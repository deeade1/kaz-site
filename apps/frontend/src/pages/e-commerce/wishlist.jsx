<div class="content-inner pb-0 container-fluid" id="page_layout">
    ...
    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-2 row-cols-xl-3 mt-4 ">
        <div class="col" data-item="list">
            <div class="card flex-row">
                <div class="card-header rounded-0 rounded-start bg-light p-0">
                    <img src="../e-commerce/assets/images/wishlist/4.png" class="img-fluid h-100 p-3" alt="wishlist-img" loading="lazy">
                </div>
                <div class="card-body rounded-end ">
                    ...
                    <div class="d-flex justify-content-between mb-4">
                        <p class="mb-0">$56.00<small class="text-success"> 15% Off</small></p>
                        <p class="mb-0">(412)</p>
                    </div>
                    <div class="d-flex justify-content-between">
                        <div class="d-flex gap-2">
                            <a class="btn btn-primary btn-icon btn-sm rounded-pill" href="../e-commerce/order-process.html" role="button">
                            ...
                            <button class="btn btn-primary btn-icon btn-sm rounded-pill delete-btn" type="button">
                                <span class="btn-inner">
                                    <svg class="icon-24" width="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <button class="btn btn-primary-subtle btn-icon btn-sm rounded-pill" data-bs-toggle="offcanvas" data-bs-target="#share-btn" aria-controls="share-btn">
                            <span class="btn-inner">
        ...
        </div>        <div class="col" data-item="list">
            <div class="card flex-row">
                <div class="card-header rounded-0 rounded-start bg-light p-0">
                    <img src="../e-commerce/assets/images/wishlist/6.png" class="img-fluid h-100 p-3" alt="wishlist-img" loading="lazy">
                </div>
                <div class="card-body rounded-end ">
                    <div class="d-flex justify-content-between mb-2">
                        <h5 class="mb-0">Jacket</h5>
                        <div class="d-flex align-items-center gap-2">
                            <svg class="icon-18" width="18" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M10.1043 0.677006L11.9317 4.32776C12.1108 4.68616 12.4565 4.93467 12.8573 4.99218L16.9453 5.58062C17.9554 5.72644 18.3573 6.95054 17.6263 7.65194L14.6702 10.4924C14.3797 10.7718 14.2474 11.1733 14.3162 11.5676L15.0138 15.5778C15.1856 16.5698 14.1298 17.3267 13.227 16.8574L9.57321 14.9627C9.21502 14.7768 8.78602 14.7768 8.42679 14.9627L4.773 16.8574C3.87023 17.3267 2.81439 16.5698 2.98724 15.5778L3.68385 11.5676C3.75257 11.1733 3.62033 10.7718 3.32982 10.4924L0.37368 7.65194C-0.357285 6.95054 0.0446417 5.72644 1.05466 5.58062L5.14265 4.99218C5.54354 4.93467 5.89028 4.68616 6.06937 4.32776L7.89574 0.677006C8.34765 -0.225669 9.65235 -0.225669 10.1043 0.677006Z" fill="#FFD329"></path>
                            </svg>
                    ...
                    <div class="d-flex justify-content-between mb-4">
                        <p class="mb-0">$80.00<small class="text-success"> 10% Off</small></p>
                        <p class="mb-0">(865)</p>
                    </div>
                    <div class="d-flex justify-content-between">
                        <div class="d-flex gap-2">
            ...
            <div class="card flex-row">
                <div class="card-header rounded-0 rounded-start bg-light p-0">
                    <img src="../e-commerce/assets/images/wishlist/5.png" class="img-fluid h-100 p-3" alt="wishlist-img" loading="lazy">
                </div>
                <div class="card-body rounded-end ">
                    <div class="d-flex justify-content-between mb-2">
                        <h5 class="mb-0">Leather Bag</h5>
                        <div class="d-flex align-items-center gap-2">
                            <svg class="icon-18" width="18" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M10.1043 0.677006L11.9317 4.32776C12.1108 4.68616 12.4565 4.93467 12.8573 4.99218L16.9453 5.58062C17.9554 5.72644 18.3573 6.95054 17.6263 7.65194L14.6702 10.4924C14.3797 10.7718 14.2474 11.1733 14.3162 11.5676L15.0138 15.5778C15.1856 16.5698 14.1298 17.3267 13.227 16.8574L9.57321 14.9627C9.21502 14.7768 8.78602 14.7768 8.42679 14.9627L4.773 16.8574C3.87023 17.3267 2.81439 16.5698 2.98724 15.5778L3.68385 11.5676C3.75257 11.1733 3.62033 10.7718 3.32982 10.4924L0.37368 7.65194C-0.357285 6.95054 0.0446417 5.72644 1.05466 5.58062L5.14265 4.99218C5.54354 4.93467 5.89028 4.68616 6.06937 4.32776L7.89574 0.677006C8.34765 -0.225669 9.65235 -0.225669 10.1043 0.677006Z" fill="#FFD329"></path>
                            </svg>
                    ...
                    <div class="d-flex justify-content-between mb-4">
                        <p class="mb-0">$10.00<small class="text-success"> 50% Off</small></p>
                        <p class="mb-0">(384)</p>
                    </div>
                    <div class="d-flex justify-content-between">
                        <div class="d-flex gap-2">
            ...
            <div class="card flex-row">
                <div class="card-header rounded-0 rounded-start bg-light p-0">
                    <img src="../e-commerce/assets/images/wishlist/8.png" class="img-fluid h-100 p-3" alt="wishlist-img" loading="lazy">
                </div>
                <div class="card-body rounded-end ">
                    <div class="d-flex justify-content-between mb-2">
                        <h5 class="mb-0">Sweatshirt</h5>
                        <div class="d-flex align-items-center gap-2">
                            <svg class="icon-18" width="18" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M10.1043 0.677006L11.9317 4.32776C12.1108 4.68616 12.4565 4.93467 12.8573 4.99218L16.9453 5.58062C17.9554 5.72644 18.3573 6.95054 17.6263 7.65194L14.6702 10.4924C14.3797 10.7718 14.2474 11.1733 14.3162 11.5676L15.0138 15.5778C15.1856 16.5698 14.1298 17.3267 13.227 16.8574L9.57321 14.9627C9.21502 14.7768 8.78602 14.7768 8.42679 14.9627L4.773 16.8574C3.87023 17.3267 2.81439 16.5698 2.98724 15.5778L3.68385 11.5676C3.75257 11.1733 3.62033 10.7718 3.32982 10.4924L0.37368 7.65194C-0.357285 6.95054 0.0446417 5.72644 1.05466 5.58062L5.14265 4.99218C5.54354 4.93467 5.89028 4.68616 6.06937 4.32776L7.89574 0.677006C8.34765 -0.225669 9.65235 -0.225669 10.1043 0.677006Z" fill="#FFD329"></path>
                            </svg>
            ...
            <div class="card flex-row">
                <div class="card-header rounded-0 rounded-start bg-light p-0">
                    <img src="../e-commerce/assets/images/wishlist/1.png" class="img-fluid h-100 p-3" alt="wishlist-img" loading="lazy">
                </div>
                <div class="card-body rounded-end ">
                    <div class="d-flex justify-content-between mb-2">
                        <h5 class="mb-0">Hand Bag</h5>
                        <div class="d-flex align-items-center gap-2">
                            <svg class="icon-18" width="18" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M10.1043 0.677006L11.9317 4.32776C12.1108 4.68616 12.4565 4.93467 12.8573 4.99218L16.9453 5.58062C17.9554 5.72644 18.3573 6.95054 17.6263 7.65194L14.6702 10.4924C14.3797 10.7718 14.2474 11.1733 14.3162 11.5676L15.0138 15.5778C15.1856 16.5698 14.1298 17.3267 13.227 16.8574L9.57321 14.9627C9.21502 14.7768 8.78602 14.7768 8.42679 14.9627L4.773 16.8574C3.87023 17.3267 2.81439 16.5698 2.98724 15.5778L3.68385 11.5676C3.75257 11.1733 3.62033 10.7718 3.32982 10.4924L0.37368 7.65194C-0.357285 6.95054 0.0446417 5.72644 1.05466 5.58062L5.14265 4.99218C5.54354 4.93467 5.89028 4.68616 6.06937 4.32776L7.89574 0.677006C8.34765 -0.225669 9.65235 -0.225669 10.1043 0.677006Z" fill="#FFD329"></path>
                            </svg>
            ...
            <div class="card flex-row">
                <div class="card-header rounded-0 rounded-start bg-light p-0">
                    <img src="../e-commerce/assets/images/wishlist/3.png" class="img-fluid h-100 p-3" alt="wishlist-img" loading="lazy">
                </div>
                <div class="card-body rounded-end ">
                    <div class="d-flex justify-content-between mb-2">
                        <h5 class="mb-0">Pencil Heels</h5>
                        <div class="d-flex align-items-center gap-2">
                            <svg class="icon-18" width="18" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M10.1043 0.677006L11.9317 4.32776C12.1108 4.68616 12.4565 4.93467 12.8573 4.99218L16.9453 5.58062C17.9554 5.72644 18.3573 6.95054 17.6263 7.65194L14.6702 10.4924C14.3797 10.7718 14.2474 11.1733 14.3162 11.5676L15.0138 15.5778C15.1856 16.5698 14.1298 17.3267 13.227 16.8574L9.57321 14.9627C9.21502 14.7768 8.78602 14.7768 8.42679 14.9627L4.773 16.8574C3.87023 17.3267 2.81439 16.5698 2.98724 15.5778L3.68385 11.5676C3.75257 11.1733 3.62033 10.7718 3.32982 10.4924L0.37368 7.65194C-0.357285 6.95054 0.0446417 5.72644 1.05466 5.58062L5.14265 4.99218C5.54354 4.93467 5.89028 4.68616 6.06937 4.32776L7.89574 0.677006C8.34765 -0.225669 9.65235 -0.225669 10.1043 0.677006Z" fill="#FFD329"></path>
                            </svg>
            ...
            <div class="card flex-row">
                <div class="card-header rounded-0 rounded-start bg-light p-0">
                    <img src="../e-commerce/assets/images/wishlist/2.png" class="img-fluid h-100 p-3" alt="wishlist-img" loading="lazy">
                </div>
                <div class="card-body rounded-end ">
                    <div class="d-flex justify-content-between mb-2">
                        <h5 class="mb-0">Casual Shoe</h5>
                        <div class="d-flex align-items-center gap-2">
                            <svg class="icon-18" width="18" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M10.1043 0.677006L11.9317 4.32776C12.1108 4.68616 12.4565 4.93467 12.8573 4.99218L16.9453 5.58062C17.9554 5.72644 18.3573 6.95054 17.6263 7.65194L14.6702 10.4924C14.3797 10.7718 14.2474 11.1733 14.3162 11.5676L15.0138 15.5778C15.1856 16.5698 14.1298 17.3267 13.227 16.8574L9.57321 14.9627C9.21502 14.7768 8.78602 14.7768 8.42679 14.9627L4.773 16.8574C3.87023 17.3267 2.81439 16.5698 2.98724 15.5778L3.68385 11.5676C3.75257 11.1733 3.62033 10.7718 3.32982 10.4924L0.37368 7.65194C-0.357285 6.95054 0.0446417 5.72644 1.05466 5.58062L5.14265 4.99218C5.54354 4.93467 5.89028 4.68616 6.06937 4.32776L7.89574 0.677006C8.34765 -0.225669 9.65235 -0.225669 10.1043 0.677006Z" fill="#FFD329"></path>
                            </svg>
            ...
            <div class="card flex-row">
                <div class="card-header rounded-0 rounded-start bg-light p-0">
                    <img src="../e-commerce/assets/images/wishlist/9.png" class="img-fluid h-100 p-3" alt="wishlist-img" loading="lazy">
                </div>
                <div class="card-body rounded-end ">
                    <div class="d-flex justify-content-between mb-2">
                        <h5 class="mb-0">Blue Shrug</h5>
                        <div class="d-flex align-items-center gap-2">
                            <svg class="icon-18" width="18" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M10.1043 0.677006L11.9317 4.32776C12.1108 4.68616 12.4565 4.93467 12.8573 4.99218L16.9453 5.58062C17.9554 5.72644 18.3573 6.95054 17.6263 7.65194L14.6702 10.4924C14.3797 10.7718 14.2474 11.1733 14.3162 11.5676L15.0138 15.5778C15.1856 16.5698 14.1298 17.3267 13.227 16.8574L9.57321 14.9627C9.21502 14.7768 8.78602 14.7768 8.42679 14.9627L4.773 16.8574C3.87023 17.3267 2.81439 16.5698 2.98724 15.5778L3.68385 11.5676C3.75257 11.1733 3.62033 10.7718 3.32982 10.4924L0.37368 7.65194C-0.357285 6.95054 0.0446417 5.72644 1.05466 5.58062L5.14265 4.99218C5.54354 4.93467 5.89028 4.68616 6.06937 4.32776L7.89574 0.677006C8.34765 -0.225669 9.65235 -0.225669 10.1043 0.677006Z" fill="#FFD329"></path>
                            </svg>
            ...
            <div class="card flex-row">
                <div class="card-header rounded-0 rounded-start bg-light p-0">
                    <img src="../e-commerce/assets/images/wishlist/7.png" class="img-fluid h-100 p-3" alt="wishlist-img" loading="lazy">
                </div>
                <div class="card-body rounded-end ">
                    <div class="d-flex justify-content-between mb-2">
                        <h5 class="mb-0">Fancy Bag</h5>
                        <div class="d-flex align-items-center gap-2">
                            <svg class="icon-18" width="18" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M10.1043 0.677006L11.9317 4.32776C12.1108 4.68616 12.4565 4.93467 12.8573 4.99218L16.9453 5.58062C17.9554 5.72644 18.3573 6.95054 17.6263 7.65194L14.6702 10.4924C14.3797 10.7718 14.2474 11.1733 14.3162 11.5676L15.0138 15.5778C15.1856 16.5698 14.1298 17.3267 13.227 16.8574L9.57321 14.9627C9.21502 14.7768 8.78602 14.7768 8.42679 14.9627L4.773 16.8574C3.87023 17.3267 2.81439 16.5698 2.98724 15.5778L3.68385 11.5676C3.75257 11.1733 3.62033 10.7718 3.32982 10.4924L0.37368 7.65194C-0.357285 6.95054 0.0446417 5.72644 1.05466 5.58062L5.14265 4.99218C5.54354 4.93467 5.89028 4.68616 6.06937 4.32776L7.89574 0.677006C8.34765 -0.225669 9.65235 -0.225669 10.1043 0.677006Z" fill="#FFD329"></path>
                            </svg>

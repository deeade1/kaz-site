        ...
        <div class="content-inner pb-0 container-fluid" id="page_layout">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-7">
                            <div class="product-slider slider-circle-btn">
                                <div class="swiper-container gallery-top text-end swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events">
                                    <div class="swiper-wrapper" id="swiper-wrapper-56fcb7107369e99a1" aria-live="polite" style="transform: translate3d(-3240px, 0px, 0px); transition-duration: 0ms;"><div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-prev" data-swiper-slide-index="4" role="group" aria-label="5 / 7" style="width: 395px; margin-right: 10px;">
                                            <img alt="product-17" src="../e-commerce/assets/images/bag-product/50.png" loading="lazy" />
                                        </div><div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" data-swiper-slide-index="5" role="group" aria-label="6 / 7" style="width: 395px; margin-right: 10px;">
                                            <img alt="product-17" src="../e-commerce/assets/images/bag-product/60.png" loading="lazy" />
                                        </div><div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next" data-swiper-slide-index="6" role="group" aria-label="7 / 7" style="width: 395px; margin-right: 10px;">
                                            <img alt="product-17" src="../e-commerce/assets/images/bag-product/90.png" loading="lazy" />
                                        </div>
                                        <div class="swiper-slide" data-swiper-slide-index="0" role="group" aria-label="1 / 7" style="width: 395px; margin-right: 10px;">
                                            <img alt="product-15" src="../e-commerce/assets/images/bag-product/10.png" loading="lazy" />
                                        </div>
                                        <div class="swiper-slide" data-swiper-slide-index="1" role="group" aria-label="2 / 7" style="width: 395px; margin-right: 10px;">
                                            <img alt="product-16" src="../e-commerce/assets/images/bag-product/20.png" loading="lazy" />
                                        </div>
                                        <div class="swiper-slide" data-swiper-slide-index="2" role="group" aria-label="3 / 7" style="width: 395px; margin-right: 10px;">
                                            <img alt="product-17" src="../e-commerce/assets/images/bag-product/30.png" loading="lazy" />
                                        </div>
                                        <div class="swiper-slide" data-swiper-slide-index="3" role="group" aria-label="4 / 7" style="width: 395px; margin-right: 10px;">
                                            <img alt="product-17" src="../e-commerce/assets/images/bag-product/40.png" loading="lazy" />
                                        </div>
                                            <div class="swiper-slide swiper-slide-prev" data-swiper-slide-index="4" role="group" aria-label="5 / 7" style="width: 395px; margin-right: 10px;">
                                            <img alt="product-17" src="../e-commerce/assets/images/bag-product/50.png" loading="lazy" />
                                        </div>
                                            <div class="swiper-slide swiper-slide-active" data-swiper-slide-index="5" role="group" aria-label="6 / 7" style="width: 395px; margin-right: 10px;">
                                            <img alt="product-17" src="../e-commerce/assets/images/bag-product/60.png" loading="lazy" />
                                        </div>
                                            <div class="swiper-slide swiper-slide-next" data-swiper-slide-index="6" role="group" aria-label="7 / 7" style="width: 395px; margin-right: 10px;">
                                            <img alt="product-17" src="../e-commerce/assets/images/bag-product/90.png" loading="lazy" />
                                        </div>
                                    <div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="0" role="group" aria-label="1 / 7" style="width: 395px; margin-right: 10px;">
                                            <img alt="product-15" src="../e-commerce/assets/images/bag-product/10.png" loading="lazy" />
                                        </div><div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="1" role="group" aria-label="2 / 7" style="width: 395px; margin-right: 10px;">
                                            <img alt="product-16" src="../e-commerce/assets/images/bag-product/20.png" loading="lazy" />
                                        </div><div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="2" role="group" aria-label="3 / 7" style="width: 395px; margin-right: 10px;">
                                            <img alt="product-17" src="../e-commerce/assets/images/bag-product/30.png" loading="lazy" />
                                        </div></div>
                                    <div class="swiper-button swiper-button-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-56fcb7107369e99a1"></div>
                                    <div class="swiper-button swiper-button-prev" tabindex="0" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-56fcb7107369e99a1"></div>
                                    <button class="btn btn-secondary-subtle rounded-circle btn-lg btn-icon" data-bs-toggle="modal" data-bs-target="#product-viewer360">
                                        <span class="btn-inner">
                                            <svg class="icon-24" width="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4 11C1.38269 11.6145 1 12.5806 1 13.6671C1 15.3749 5.16801 16.7852 10.5652 17M18.964 11.0651C21.4277 11.6815 23 12.6182 23 13.6671C23 15.2725 19.3166 16.6151 14.3913 16.9487" stroke="currentColor" stroke-linecap="round"></path>
                                                <path d="M8.85788 14L11.2777 17.0142L8 19.0636" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path>
                                            </svg>
                                        </span>
                                    </button>
                                <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span></div>
                                <div class="swiper-container gallery-thumbs swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events">
                                    <div class="swiper-wrapper" id="swiper-wrapper-d655880831c3cc87" aria-live="polite" style="transition-duration: 0ms; transform: translate3d(-889.104px, 0px, 0px);"><div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-prev" data-swiper-slide-index="4" role="group" aria-label="5 / 7" style="margin-right: 10px;">
                                            <img alt="product-19" src="../e-commerce/assets/images/bag-product/50.png" loading="lazy" />
                                        </div><div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" data-swiper-slide-index="5" role="group" aria-label="6 / 7" style="margin-right: 10px;">
                                            <img alt="product-20" src="../e-commerce/assets/images/bag-product/60.png" loading="lazy" />
                                        </div><div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next" data-swiper-slide-index="6" role="group" aria-label="7 / 7" style="margin-right: 10px;">
                                            <img alt="product-20" src="../e-commerce/assets/images/bag-product/90.png" loading="lazy" />
                                        </div>
                                        <div class="swiper-slide" data-swiper-slide-index="0" role="group" aria-label="1 / 7" style="margin-right: 10px;">
                                            <img alt="product-19" src="../e-commerce/assets/images/bag-product/10.png" loading="lazy" />
                                        </div>
                                        <div class="swiper-slide" data-swiper-slide-index="1" role="group" aria-label="2 / 7" style="margin-right: 10px;">
                                            <img alt="product-20" src="../e-commerce/assets/images/bag-product/20.png" loading="lazy" />
                                        </div>
                                        <div class="swiper-slide" data-swiper-slide-index="2" role="group" aria-label="3 / 7" style="margin-right: 10px;">
                                            <img alt="product-21" src="../e-commerce/assets/images/bag-product/30.png" loading="lazy" />
                                        </div>
                                        <div class="swiper-slide" data-swiper-slide-index="3" role="group" aria-label="4 / 7" style="margin-right: 10px;">
                                            <img alt="product-22" src="../e-commerce/assets/images/bag-product/40.png" loading="lazy" />
                                        </div>
                                            <div class="swiper-slide swiper-slide-prev" data-swiper-slide-index="4" role="group" aria-label="5 / 7" style="margin-right: 10px;">
                                            <img alt="product-19" src="../e-commerce/assets/images/bag-product/50.png" loading="lazy" />
                                        </div>
                                        <div class="swiper-slide swiper-slide-active" data-swiper-slide-index="5" role="group" aria-label="6 / 7" style="margin-right: 10px;">
                                            <img alt="product-20" src="../e-commerce/assets/images/bag-product/60.png" loading="lazy" />
                                        </div>
                                        <div class="swiper-slide swiper-slide-next" data-swiper-slide-index="6" role="group" aria-label="7 / 7" style="margin-right: 10px;">
                                            <img alt="product-20" src="../e-commerce/assets/images/bag-product/90.png" loading="lazy" />
                                        </div>
                                    <div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="0" role="group" aria-label="1 / 7" style="margin-right: 10px;">
                                            <img alt="product-19" src="../e-commerce/assets/images/bag-product/10.png" loading="lazy" />
                                        </div><div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="1" role="group" aria-label="2 / 7" style="margin-right: 10px;">
                                            <img alt="product-20" src="../e-commerce/assets/images/bag-product/20.png" loading="lazy" />
                                        </div><div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="2" role="group" aria-label="3 / 7" style="margin-right: 10px;">
                                            <img alt="product-21" src="../e-commerce/assets/images/bag-product/30.png" loading="lazy" />
                                        </div></div>
                                <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span></div>
                            </div>
                            ...
                            <div class="modal-dialog modal-xl" style="max-width: 1400px;">
                                <div class="modal-content  bg-transparent border-0 shadow-none">
                                    <div class="model-header text-end">
                                        <button type="button" class="btn btn-light m-2" aria-label="Close" data-bs-dismiss="modal">close</button>
                                    </div>
                                    <div class="modal-body">
                                        <div class="row vh-80 align-items-center">
                                            <div class="col-12">
                                                <div class="d-flex flex-column">
                                                    <div class="cloudimage-360" data-folder="../e-commerce/assets/images/bag-product/" data-filename="{index}.png" data-amount-x="120" data-hide-360-logo="true" data-pointer-zoom="2"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-5 mt-4 mt-lg-0">
                            <div class="border-bottom">
                                <div class="d-flex flex-column align-content-between justify-items-center mb-3">
                                    <div class="d-flex justify-content-between mb-2">
                                        ...
                                        <div class="d-flex justify-content-end ">
                                            <button class="btn btn-primary-subtle btn-icon rounded-pill" data-bs-toggle="offcanvas" data-bs-target="#share-btn" aria-controls="share-btn">
                                                <span class="btn-inner">
                                ...
                                <div class="d-flex my-4 gap-2">
                                    ...
                                    <h4 class="text-primary mb-0">$45.99</h4>
                                </div>
                            </div>
                            <div class="border-bottom">
                            ...
                            <div class="d-flex flex-column py-4">
                                <div class="d-flex align-items-center mb-3 gap-2">
                                    ...
                                    <span class="text-primary ">Thursday, April 07</span>
                                </div>
                                <div class="d-flex align-items-center mb-3 gap-2">
                            ...
                            <div>
                                ...
                                <div class="d-flex py-4 flex-wrap gap-4">
                                    <a href="./order-process.html" class="btn btn-warning d-flex gap-2 align-items-center">
                                    ...
                                    <a href="./wishlist.html" class="btn btn-info d-flex gap-2 align-items-center">
                                        <span class="btn-inner d-flex ">
                                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="card-body">
                    <nav class="tab-bottom-bordered">
                        <div class="mb-0 nav nav-tabs" id="nav-tab1" role="tablist">
                            ...
                            <button class="nav-link" id="nav-info-tab" data-bs-toggle="tab" data-bs-target="#nav-info" type="button" role="tab" aria-controls="nav-info" aria-selected="false" tabindex="-1">Info</button>
                        ...
                        <div class="tab-pane fade show active" id="nav-description" role="tabpanel" aria-labelledby="nav-description-tab">
                            <div class="d-flex flex-column">
                                ...
                                <div class="row row-cols-2 row-cols-lg-5 py-3">
                                    <div class="col">
                                        <img src="..//e-commerce/assets/images/bag-product/10.png" alt="product-details" class="img-fluid iq-product-img rounded-2 w-100 " loading="lazy" />
                                    </div>
                                    <div class="col">
                                        <img src="..//e-commerce/assets/images/bag-product/31.png" alt="product-details" class="img-fluid iq-product-img rounded-2  w-100 " loading="lazy" />
                                    </div>
                                    <div class="col">
                                        <img src="..//e-commerce/assets/images/bag-product/52.png" alt="product-details" class="img-fluid iq-product-img rounded-2 w-100  " loading="lazy" />
                                    </div>
                                    <div class="col">
                                        <img src="..//e-commerce/assets/images/bag-product/83.png" alt="product-details" class="img-fluid iq-product-img rounded-2  w-100 " loading="lazy" />
                                    </div>
                                    <div class="col">
                                        <img src="..//e-commerce/assets/images/bag-product/103.png" alt="product-details" class="img-fluid iq-product-img rounded-2  w-100  " loading="lazy" />
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane fade" id="nav-review" role="tabpanel" aria-labelledby="nav-review-tab">
                            ...
                            <div>
                                <div class="card shadow-none bg-transparent border">
                                    <div class="card-body">
                                        <div class="d-flex flex-sm-nowrap flex-wrap gap-sm-3 gap-0">
                                            <div>
                                                <img class="img-fluid object-contain avatar-120 rounded" src="../e-commerce/assets/images/user/04.png" alt="01" loading="lazy" />
                                            </div>
                                            <div>
                                ...
                                <div class="card shadow-none bg-transparent border">
                                    <div class="card-body">
                                        <div class="d-flex flex-sm-nowrap flex-wrap gap-sm-3 gap-0">
                                            <div>
                                                <img class="img-fluid object-contain avatar-120 rounded" src="../e-commerce/assets/images/user/01.png" alt="01" loading="lazy" />
                                            </div>
                                            <div>
                                                <div class="d-flex justify-content-between align-items-center my-2 my-lg-0">
                                                ...
                                                <div class="d-flex mb-3 gap-3">
                                                    ...
                                                    <a class="text-body " href="javascript:void(0)">Cancel Reply</a>
                                                </div>
                                                <div class="col-lg-12">
            ...
            <div class="row row-cols-1">
                ...
                <div class="overflow-hidden slider-circle-btn swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events" id="ecommerce-slider">
                    <ul class="p-0 m-0 mb-2 swiper-wrapper list-inline" id="swiper-wrapper-422fffefb7fcc246" aria-live="polite" style="transform: translate3d(0px, 0px, 0px);">
                        <li class="swiper-slide card-slide swiper-slide-active" role="group" aria-label="1 / 7" style="width: 424px; margin-right: 32px;">
                            <div>
                        ...
                        <li class="swiper-slide card-slide swiper-slide-next" role="group" aria-label="2 / 7" style="width: 424px; margin-right: 32px;">
                            <div>
                                <div class="card iq-product-custom-card animate:hover-media ">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center mb-1">
                                            <a href="../e-commerce/product-detail.html" class="h6 iq-product-detail mb-0">Pink Triusers</a>
                                                <div class="d-flex align-items-center">
                                                    <svg class="icon-24" xmlns="http://www.w3.org/2000/svg" width="24" viewBox="0 0 24 24" fill="none">
                                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M13.1043 4.17701L14.9317 7.82776C15.1108 8.18616 15.4565 8.43467 15.8573 8.49218L19.9453 9.08062C20.9554 9.22644 21.3573 10.4505 20.6263 11.1519L17.6702 13.9924C17.3797 14.2718 17.2474 14.6733 17.3162 15.0676L18.0138 19.0778C18.1856 20.0698 17.1298 20.8267 16.227 20.3574L12.5732 18.4627C12.215 18.2768 11.786 18.2768 11.4268 18.4627L7.773 20.3574C6.87023 20.8267 5.81439 20.0698 5.98724 19.0778L6.68385 15.0676C6.75257 14.6733 6.62033 14.2718 6.32982 13.9924L3.37368 11.1519C2.64272 10.4505 3.04464 9.22644 4.05466 9.08062L8.14265 8.49218C8.54354 8.43467 8.89028 8.18616 9.06937 7.82776L10.8957 4.17701C11.3477 3.27433 12.6523 3.27433 13.1043 4.17701Z" fill="#FFD329"></path>
                                                    </svg>
                        ...
                        <li class="swiper-slide card-slide" role="group" aria-label="3 / 7" style="width: 424px; margin-right: 32px;">
                            <div>
                                <div class="card iq-product-custom-card animate:hover-media ">
                                    <div class="iq-product-hover-img position-relative animate:hover-media-wrap">
                                        <a href="../e-commerce/product-detail.html">
                        ...
                        <li class="swiper-slide card-slide" role="group" aria-label="4 / 7" style="width: 424px; margin-right: 32px;">
                            <div>
                                <div class="card iq-product-custom-card animate:hover-media ">
                                    <div class="iq-product-hover-img position-relative animate:hover-media-wrap">
                                        <a href="../e-commerce/product-detail.html">
                        ...
                        <li class="swiper-slide card-slide" role="group" aria-label="5 / 7" style="width: 424px; margin-right: 32px;">
                            <div>
                                <div class="card iq-product-custom-card animate:hover-media ">
                                    <div class="iq-product-hover-img position-relative animate:hover-media-wrap">
                                        <a href="../e-commerce/product-detail.html">
                        ...
                        <li class="swiper-slide card-slide" role="group" aria-label="6 / 7" style="width: 424px; margin-right: 32px;">
                            <div>
                                <div class="card iq-product-custom-card animate:hover-media ">
                                    <div class="iq-product-hover-img position-relative animate:hover-media-wrap">
                                        <a href="../e-commerce/product-detail.html">
                        ...
                        <li class="swiper-slide card-slide" role="group" aria-label="7 / 7" style="width: 424px; margin-right: 32px;">
                            <div>
                                <div class="card iq-product-custom-card animate:hover-media ">
                                    <div class="iq-product-hover-img position-relative animate:hover-media-wrap">
                                        <a href="../e-commerce/product-detail.html">
                    ...
                    <div class="swiper-button swiper-button-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-422fffefb7fcc246" aria-disabled="false"></div>
                    <div class="swiper-button swiper-button-prev swiper-button-disabled" tabindex="-1" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-422fffefb7fcc246" aria-disabled="true"></div>
                <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span></div>
            </div>

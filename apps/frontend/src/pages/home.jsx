...
import bannerTop from '@/assets/landing-modules/images/home-1/banner-top.webp';

import aboutUs from '@/assets/landing-modules/images/home-1/about-us.webp'
            ...
            <Container>
                <Row>
                    <Col sm={6} className="col-sm-6 banner-one-img text-center ms-2 ms-sm-0">
                     <img src={bannerTop} alt="img" className="img-fluid "/>
                    </Col>

const GroupDetail = memo(() => {
    ...
    <div class="content-inner pb-0 container-fluid" id="page_layout">
        <div class="row">
            <div class="col-lg-12">
                <div class="d-flex align-items-center justify-content-between mb-3 gap-4 flex-wrap">
                    ...
                    <div class="group-member d-flex align-items-center gap-3">
                        <div class="iq-media-group">
                            <a href="#" class="iq-media">
                                <img class="img-fluid avatar-40 rounded-circle" src="../social-app/assets/images/avatar/01.png" alt="" loading="lazy" />
                            </a>
                            <a href="#" class="iq-media">

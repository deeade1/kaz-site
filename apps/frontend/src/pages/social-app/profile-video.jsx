        ...
        <div class="d-grid gap-3 d-grid-template-1fr-19">
            <div class="user-images position-relative overflow-hidden">
                <div class="ratio ratio-16x9">
                    <iframe loading="lazy" src="https://www.youtube.com/embed/OGuX3lO5Gjs" allowfullscreen=""></iframe>
                </div>
            ...
            <div class="user-images position-relative overflow-hidden">
                <div class="ratio ratio-16x9">
                    <iframe loading="lazy" src="https://www.youtube.com/embed/DL93L26UsI0" allowfullscreen=""></iframe>
                </div>
                <div class="image-hover-data">
                    <div class="product-elements-icon">
                        <ul class="d-flex align-items-center gap-3 m-0 p-0 list-inline">
            ...
            <div class="user-images position-relative overflow-hidden">
                <div class="ratio ratio-16x9">
                    <iframe loading="lazy" src="https://www.youtube.com/embed/gGUCCh8XedI" allowfullscreen=""></iframe>
                </div>
                <div class="image-hover-data">
                    <div class="product-elements-icon">
                        <ul class="d-flex align-items-center gap-3 m-0 p-0 list-inline">
            ...
            <div class="user-images position-relative overflow-hidden">
                <div class="ratio ratio-16x9">
                    <iframe loading="lazy" src="https://www.youtube.com/embed/1hUPsry0LjQ" allowfullscreen=""></iframe>
                </div>
                <div class="image-hover-data">
                    <div class="product-elements-icon">
                        <ul class="d-flex align-items-center gap-3 m-0 p-0 list-inline">
            ...
            <div class="user-images position-relative overflow-hidden">
                <div class="ratio ratio-16x9">
                    <iframe loading="lazy" src="https://www.youtube.com/embed/PHF0lmDBmXo" allowfullscreen=""></iframe>
                </div>
                <div class="image-hover-data">
                    <div class="product-elements-icon">
                        <ul class="d-flex align-items-center gap-3 m-0 p-0 list-inline">
            ...
            <div class="user-images position-relative overflow-hidden">
                <div class="ratio ratio-16x9">
                    <iframe loading="lazy" src="https://www.youtube.com/embed/d1ri9sCseTk" allowfullscreen=""></iframe>
                </div>
                <div class="image-hover-data">
                    <div class="product-elements-icon">
                        <ul class="d-flex align-items-center gap-3 m-0 p-0 list-inline">
            ...
            <div class="user-images position-relative overflow-hidden">
                <div class="ratio ratio-16x9">
                    <iframe loading="lazy" src="https://www.youtube.com/embed/J7tNLM2iBlE" allowfullscreen=""></iframe>
                </div>
                <div class="image-hover-data">
                    <div class="product-elements-icon">
                        <ul class="d-flex align-items-center gap-3 m-0 p-0 list-inline">
            ...
            <div class="user-images position-relative overflow-hidden">
                <div class="ratio ratio-16x9">
                    <iframe loading="lazy" src="https://www.youtube.com/embed/8yiFq4FYWlQ" allowfullscreen=""></iframe>
                </div>
                <div class="image-hover-data">
                    <div class="product-elements-icon">
                        <ul class="d-flex align-items-center gap-3 m-0 p-0 list-inline">
            ...
            <div class="user-images position-relative overflow-hidden">
                <div class="ratio ratio-16x9">
                    <iframe loading="lazy" src="https://www.youtube.com/embed/78mPwkO6aek" allowfullscreen=""></iframe>
                </div>
                <div class="image-hover-data">
                    <div class="product-elements-icon">
                        <ul class="d-flex align-items-center gap-3 m-0 p-0 list-inline">
            ...
            <div class="user-images position-relative overflow-hidden">
                <div class="ratio ratio-16x9">
                    <iframe loading="lazy" src="https://www.youtube.com/embed/3OMj6nqDuAA" allowfullscreen=""></iframe>
                </div>
                <div class="image-hover-data">
                    <div class="product-elements-icon">
                        <ul class="d-flex align-items-center gap-3 m-0 p-0 list-inline">
            ...
            <div class="user-images position-relative overflow-hidden">
                <div class="ratio ratio-16x9">
                    <iframe loading="lazy" src="https://www.youtube.com/embed/VeDdpy4CdeM" allowfullscreen=""></iframe>
                </div>
                <div class="image-hover-data">
                    <div class="product-elements-icon">
                        <ul class="d-flex align-items-center gap-3 m-0 p-0 list-inline">
            ...
            <div class="user-images position-relative overflow-hidden">
                <div class="ratio ratio-16x9">
                    <iframe loading="lazy" src="https://www.youtube.com/embed/XvtKsTbrPz0" allowfullscreen=""></iframe>
                </div>
                <div class="image-hover-data">
                    <div class="product-elements-icon">
                        <ul class="d-flex align-items-center gap-3 m-0 p-0 list-inline">
            ...
            <div class="user-images position-relative overflow-hidden">
                <div class="ratio ratio-16x9">
                    <iframe loading="lazy" src="https://www.youtube.com/embed/27hOzBaFbJU" allowfullscreen=""></iframe>
                </div>
                <div class="image-hover-data">
                    <div class="product-elements-icon">
                        <ul class="d-flex align-items-center gap-3 m-0 p-0 list-inline">
            ...
            <div class="user-images position-relative overflow-hidden">
                <div class="ratio ratio-16x9">
                    <iframe loading="lazy" src="https://www.youtube.com/embed/y1rglaseZ-k" allowfullscreen=""></iframe>
                </div>
                <div class="image-hover-data">
                    <div class="product-elements-icon">
                        <ul class="d-flex align-items-center gap-3 m-0 p-0 list-inline">
            ...
            <div class="user-images position-relative overflow-hidden">
                <div class="ratio ratio-16x9">
                    <iframe loading="lazy" src="https://www.youtube.com/embed/RntJ61yWrRI" allowfullscreen=""></iframe>
                </div>
                <div class="image-hover-data">
                    <div class="product-elements-icon">
                        <ul class="d-flex align-items-center gap-3 m-0 p-0 list-inline">
            ...
            <div class="user-images position-relative overflow-hidden">
                <div class="ratio ratio-16x9">
                    <iframe loading="lazy" src="https://www.youtube.com/embed/dVzFhSu5Mm8" allowfullscreen=""></iframe>
                </div>
                <div class="image-hover-data">
                    <div class="product-elements-icon">
                        <ul class="d-flex align-items-center gap-3 m-0 p-0 list-inline">
            ...
            <div class="user-images position-relative overflow-hidden">
                <div class="ratio ratio-16x9">
                    <iframe loading="lazy" src="https://www.youtube.com/embed/11uVhnjxjRA" allowfullscreen=""></iframe>
                </div>
                <div class="image-hover-data">
                    <div class="product-elements-icon">
                        <ul class="d-flex align-items-center gap-3 m-0 p-0 list-inline">
            ...
            <div class="user-images position-relative overflow-hidden">
                <div class="ratio ratio-16x9">
                    <iframe loading="lazy" src="https://www.youtube.com/embed/f-t7RA6gdjE" allowfullscreen=""></iframe>
                </div>
                <div class="image-hover-data">
                    <div class="product-elements-icon">
                        <ul class="d-flex align-items-center gap-3 m-0 p-0 list-inline">
            ...
            <div class="user-images position-relative overflow-hidden">
                <div class="ratio ratio-16x9">
                    <iframe loading="lazy" src="https://www.youtube.com/embed/dctRWhSabrU" allowfullscreen=""></iframe>
                </div>
                <div class="image-hover-data">
                    <div class="product-elements-icon">
                        <ul class="d-flex align-items-center gap-3 m-0 p-0 list-inline">
            ...
            <div class="user-images position-relative overflow-hidden">
                <div class="ratio ratio-16x9">
                    <iframe loading="lazy" src="https://www.youtube.com/embed/Onekf3kAMog" allowfullscreen=""></iframe>
                </div>
                <div class="image-hover-data">
                    <div class="product-elements-icon">
                        <ul class="d-flex align-items-center gap-3 m-0 p-0 list-inline">
            ...
            <div class="user-images position-relative overflow-hidden">
                <div class="ratio ratio-16x9">
                    <iframe loading="lazy" src="https://www.youtube.com/embed/--6zKnvpGGk" allowfullscreen=""></iframe>
                </div>
                <div class="image-hover-data">
                    <div class="product-elements-icon">
                        <ul class="d-flex align-items-center gap-3 m-0 p-0 list-inline">

        ...
        <div class="col-lg-8">
            ...
            <div class="card">
                <div class="card-header d-flex  justify-content-between">
                    <div class="header-title">
                        <div class="d-flex justify-content-center flex-wrap gap-3">
                            <img class="img-fluid rounded-circle p-1 border border-2 border-primary border-dotted avatar-50" src="../social-app/assets/images/avatar/04.png" alt="profile-img" loading="lazy" />
                            <div class="media-support-info">
                                <div class="d-flex align-items-center mb-2 gap-2">
                                    <h6 class="mb-0">Ella Martina</h6>
                                    <small class="text-dark">Updated Her Status</small>
                                </div>
                                <p class="mb-0 text-muted">10 hrs Ago</p>
                            </div>
                        </div>
                    </div>
                    <div class="dropdown">

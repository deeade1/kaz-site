                            ...
                            <ul class="notification-list m-0 p-0">
                                <li class="d-flex align-items-center justify-content-between gap-3">
                                    <div class="user-img img-fluid">
                                        <img src="../social-app/assets/images/avatar/01.png" alt="story-img" class="rounded-circle avatar-40" loading="lazy" />
                                    </div>
                                    <div class="w-100">
                                                ...
                                                <div class="card-header-toolbar d-flex align-items-center">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                                                                <svg width="18" viewBox="0 0 24 24" class="me-3 icon-18" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                                    <g clip-path="url(#notification_0)">
                                                                    <path d="M16.0002 4.5H8.00024C6.89567 4.5 6.00024 5.39543 6.00024 6.5V6.80859H18.0002V6.5C18.0002 5.39543 17.1048 4.5 16.0002 4.5Z" fill="currentColor"></path>
                                                                    <rect x="6.00024" y="12" width="12" height="7.5" rx="2" fill="currentColor"></rect>
                                                                    <path opacity="0.4" d="M19 6.80666H5C3.89543 6.80666 3 7.70209 3 8.80665V13.6928C3 14.7974 3.89543 15.6928 5 15.6928H17.625H19C20.1046 15.6928 21 14.7974 21 13.6928V8.80666C21 7.70209 20.1046 6.80666 19 6.80666Z" fill="currentColor"></path>
                                                                    </g>
                                                                    <defs>
                                                                    <clipPath id="notification_0">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <ul class="notification-list m-0 p-0">
                                <li class="d-flex align-items-center justify-content-between gap-3">
                                    <div class="user-img img-fluid">
                                        <img src="../social-app/assets/images/avatar/02.png" alt="story-img" class="rounded-circle avatar-40" loading="lazy" />
                                    </div>
                                    <div class="w-100">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                <a href="javascript:void(0);" class=" iq-notify bg-danger-subtle rounded d-flex justify-content-center align-items-center p-1">
                                                    <svg class="icon-18" width="18" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <div class="card-header-toolbar d-flex align-items-center">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                                                                <svg width="18" viewBox="0 0 24 24" class="me-3 icon-18" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                                    <g clip-path="url(#notification_1)">
                                                                    <path d="M16.0002 4.5H8.00024C6.89567 4.5 6.00024 5.39543 6.00024 6.5V6.80859H18.0002V6.5C18.0002 5.39543 17.1048 4.5 16.0002 4.5Z" fill="currentColor"></path>
                                                                    <rect x="6.00024" y="12" width="12" height="7.5" rx="2" fill="currentColor"></rect>
                                                                    <path opacity="0.4" d="M19 6.80666H5C3.89543 6.80666 3 7.70209 3 8.80665V13.6928C3 14.7974 3.89543 15.6928 5 15.6928H17.625H19C20.1046 15.6928 21 14.7974 21 13.6928V8.80666C21 7.70209 20.1046 6.80666 19 6.80666Z" fill="currentColor"></path>
                                                                    </g>
                                                                    <defs>
                                                                    <clipPath id="notification_1">
                                                                    <rect width="24" height="24" fill="currentColor"></rect>
                                                                    </clipPath>
                                                                    </defs>
                                                                </svg>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <ul class="notification-list m-0 p-0">
                                <li class="d-flex align-items-center justify-content-between gap-3">
                                    <div class="user-img img-fluid">
                                        <img src="../social-app/assets/images/avatar/03.png" alt="story-img" class="rounded-circle avatar-40" loading="lazy" />
                                    </div>
                                    <div class="w-100">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                ...
                                                <div class="card-header-toolbar d-flex align-items-center">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                                                                <svg width="18" viewBox="0 0 24 24" class="me-3 icon-18" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                                    <g clip-path="url(#notification_2)">
                                                                    <path d="M16.0002 4.5H8.00024C6.89567 4.5 6.00024 5.39543 6.00024 6.5V6.80859H18.0002V6.5C18.0002 5.39543 17.1048 4.5 16.0002 4.5Z" fill="currentColor"></path>
                                                                    <rect x="6.00024" y="12" width="12" height="7.5" rx="2" fill="currentColor"></rect>
                                                                    <path opacity="0.4" d="M19 6.80666H5C3.89543 6.80666 3 7.70209 3 8.80665V13.6928C3 14.7974 3.89543 15.6928 5 15.6928H17.625H19C20.1046 15.6928 21 14.7974 21 13.6928V8.80666C21 7.70209 20.1046 6.80666 19 6.80666Z" fill="currentColor"></path>
                                                                    </g>
                                                                    <defs>
                                                                    <clipPath id="notification_2">
                                                                    <rect width="24" height="24" fill="currentColor"></rect>
                                                                    </clipPath>
                                                                    </defs>
                                                                </svg>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <ul class="notification-list m-0 p-0">
                                <li class="d-flex align-items-center justify-content-between gap-3">
                                    <div class="user-img img-fluid">
                                        <img src="../social-app/assets/images/avatar/04.png" alt="story-img" class="rounded-circle avatar-40" loading="lazy" />
                                    </div>
                                    <div class="w-100">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                <a href="javascript:void(0);" class=" iq-notify bg-success-subtle rounded d-flex justify-content-center align-items-center p-1">
                                                    <svg class="icon-18" width="18" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <div class="card-header-toolbar d-flex align-items-center">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                                                                <svg width="18" viewBox="0 0 24 24" class="me-3 icon-18" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                                    <g clip-path="url(#notification_3)">
                                                                    <path d="M16.0002 4.5H8.00024C6.89567 4.5 6.00024 5.39543 6.00024 6.5V6.80859H18.0002V6.5C18.0002 5.39543 17.1048 4.5 16.0002 4.5Z" fill="currentColor"></path>
                                                                    <rect x="6.00024" y="12" width="12" height="7.5" rx="2" fill="currentColor"></rect>
                                                                    <path opacity="0.4" d="M19 6.80666H5C3.89543 6.80666 3 7.70209 3 8.80665V13.6928C3 14.7974 3.89543 15.6928 5 15.6928H17.625H19C20.1046 15.6928 21 14.7974 21 13.6928V8.80666C21 7.70209 20.1046 6.80666 19 6.80666Z" fill="currentColor"></path>
                                                                    </g>
                                                                    <defs>
                                                                    <clipPath id="notification_3">
                                                                    <rect width="24" height="24" fill="currentColor"></rect>
                                                                    </clipPath>
                                                                    </defs>
                                                                </svg>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <ul class="notification-list m-0 p-0">
                                <li class="d-flex align-items-center justify-content-between gap-3">
                                    <div class="user-img img-fluid">
                                        <img src="../social-app/assets/images/avatar/16.png" alt="story-img" class="rounded-circle avatar-40" loading="lazy" />
                                    </div>
                                    <div class="w-100">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                ...
                                                <div class="card-header-toolbar d-flex align-items-center">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                                                                <svg width="18" viewBox="0 0 24 24" class="me-3 icon-18" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                                    <g clip-path="url(#notification_4)">
                                                                    <path d="M16.0002 4.5H8.00024C6.89567 4.5 6.00024 5.39543 6.00024 6.5V6.80859H18.0002V6.5C18.0002 5.39543 17.1048 4.5 16.0002 4.5Z" fill="currentColor"></path>
                                                                    <rect x="6.00024" y="12" width="12" height="7.5" rx="2" fill="currentColor"></rect>
                                                                    <path opacity="0.4" d="M19 6.80666H5C3.89543 6.80666 3 7.70209 3 8.80665V13.6928C3 14.7974 3.89543 15.6928 5 15.6928H17.625H19C20.1046 15.6928 21 14.7974 21 13.6928V8.80666C21 7.70209 20.1046 6.80666 19 6.80666Z" fill="currentColor"></path>
                                                                    </g>
                                                                    <defs>
                                                                    <clipPath id="notification_4">
                                                                    <rect width="24" height="24" fill="currentColor"></rect>
                                                                    </clipPath>
                                                                    </defs>
                                                                </svg>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <ul class="notification-list m-0 p-0">
                                <li class="d-flex align-items-center justify-content-between gap-3">
                                    <div class="user-img img-fluid">
                                        <img src="../social-app/assets/images/avatar/05.png" alt="story-img" class="rounded-circle avatar-40" loading="lazy" />
                                    </div>
                                    <div class="w-100">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                <a href="javascript:void(0);" class=" iq-notify bg-warning-subtle rounded d-flex justify-content-center align-items-center p-1">
                                                    <svg class="icon-18" width="18" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                        <path opacity="0.4" d="M20 12.5645C17.5 7.56444 13.1667 6.73113 11 7.06447V13.0645C12.5 13.0645 15.9 13.3645 17.5 14.5645C18.7911 15.5328 20.603 17.8684 21.2546 18.7343C21.3177 18.8181 21.452 18.7632 21.435 18.6597C21.233 17.4306 20.5944 13.7532 20 12.5645Z" fill="currentColor"></path>
                                                        <path d="M11.2053 16C11.0569 16 10.9107 15.9593 10.7814 15.88L2.37194 10.6625C2.14094 10.5185 2 10.2692 2 10C2 9.73086 2.14094 9.48151 2.37194 9.33754L10.7814 4.12003C11.0262 3.96876 11.3356 3.95937 11.5889 4.09813C11.8432 4.23584 12 4.49771 12 4.78252L12 15.2175C12 15.5024 11.8432 15.7642 11.5889 15.9019C11.4691 15.9677 11.3367 16 11.2053 16Z" fill="currentColor"></path>
                                                    </svg>
                                                </a>
                                                <div class="card-header-toolbar d-flex align-items-center">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                                                                <svg width="18" viewBox="0 0 24 24" class="me-3 icon-18" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                                    <g clip-path="url(#notification_5)">
                                                                    <path d="M16.0002 4.5H8.00024C6.89567 4.5 6.00024 5.39543 6.00024 6.5V6.80859H18.0002V6.5C18.0002 5.39543 17.1048 4.5 16.0002 4.5Z" fill="currentColor"></path>
                                                                    <rect x="6.00024" y="12" width="12" height="7.5" rx="2" fill="currentColor"></rect>
                                                                    <path opacity="0.4" d="M19 6.80666H5C3.89543 6.80666 3 7.70209 3 8.80665V13.6928C3 14.7974 3.89543 15.6928 5 15.6928H17.625H19C20.1046 15.6928 21 14.7974 21 13.6928V8.80666C21 7.70209 20.1046 6.80666 19 6.80666Z" fill="currentColor"></path>
                                                                    </g>
                                                                    <defs>
                                                                    <clipPath id="notification_5">
                                                                    <rect width="24" height="24" fill="currentColor"></rect>
                                                                    </clipPath>
                                                                    </defs>
                                                                </svg>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <ul class="notification-list m-0 p-0">
                                <li class="d-flex align-items-center justify-content-between gap-3">
                                    <div class="user-img img-fluid">
                                        <img src="../social-app/assets/images/avatar/06.png" alt="story-img" class="rounded-circle avatar-40" loading="lazy" />
                                    </div>
                                    <div class="w-100">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                <a href="javascript:void(0);" class=" iq-notify bg-info-subtle rounded d-flex justify-content-center align-items-center p-1">
                                                ...
                                                <div class="card-header-toolbar d-flex align-items-center">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                                                                <svg width="18" viewBox="0 0 24 24" class="me-3 icon-18" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                                    <g clip-path="url(#notification_6)">
                                                                    <path d="M16.0002 4.5H8.00024C6.89567 4.5 6.00024 5.39543 6.00024 6.5V6.80859H18.0002V6.5C18.0002 5.39543 17.1048 4.5 16.0002 4.5Z" fill="currentColor"></path>
                                                                    <rect x="6.00024" y="12" width="12" height="7.5" rx="2" fill="currentColor"></rect>
                                                                    <path opacity="0.4" d="M19 6.80666H5C3.89543 6.80666 3 7.70209 3 8.80665V13.6928C3 14.7974 3.89543 15.6928 5 15.6928H17.625H19C20.1046 15.6928 21 14.7974 21 13.6928V8.80666C21 7.70209 20.1046 6.80666 19 6.80666Z" fill="currentColor"></path>
                                                                    </g>
                                                                    <defs>
                                                                    <clipPath id="notification_6">
                                                                    <rect width="24" height="24" fill="currentColor"></rect>
                                                                    </clipPath>
                                                                    </defs>
                                                                </svg>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <ul class="notification-list m-0 p-0">
                                <li class="d-flex align-items-center justify-content-between gap-3">
                                    <div class="user-img img-fluid">
                                        <img src="../social-app/assets/images/avatar/11.png" alt="story-img" class="rounded-circle avatar-40" loading="lazy" />
                                    </div>
                                    <div class="w-100">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                ...
                                                <div class="card-header-toolbar d-flex align-items-center">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                                                                <svg width="18" viewBox="0 0 24 24" class="me-3 icon-18" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                                    <g clip-path="url(#notification_7)">
                                                                    <path d="M16.0002 4.5H8.00024C6.89567 4.5 6.00024 5.39543 6.00024 6.5V6.80859H18.0002V6.5C18.0002 5.39543 17.1048 4.5 16.0002 4.5Z" fill="currentColor"></path>
                                                                    <rect x="6.00024" y="12" width="12" height="7.5" rx="2" fill="currentColor"></rect>
                                                                    <path opacity="0.4" d="M19 6.80666H5C3.89543 6.80666 3 7.70209 3 8.80665V13.6928C3 14.7974 3.89543 15.6928 5 15.6928H17.625H19C20.1046 15.6928 21 14.7974 21 13.6928V8.80666C21 7.70209 20.1046 6.80666 19 6.80666Z" fill="currentColor"></path>
                                                                    </g>
                                                                    <defs>
                                                                    <clipPath id="notification_7">
                                                                    <rect width="24" height="24" fill="currentColor"></rect>
                                                                    </clipPath>
                                                                    </defs>
                                                                </svg>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <ul class="notification-list m-0 p-0">
                                <li class="d-flex align-items-center justify-content-between gap-3">
                                    <div class="user-img img-fluid">
                                        <img src="../social-app/assets/images/avatar/07.png" alt="story-img" class="rounded-circle avatar-40" loading="lazy" />
                                    </div>
                                    <div class="w-100">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                ...
                                                <div class="card-header-toolbar d-flex align-items-center">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                                                                <svg width="18" viewBox="0 0 24 24" class="me-3 icon-18" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                                    <g clip-path="url(#notification_8)">
                                                                    <path d="M16.0002 4.5H8.00024C6.89567 4.5 6.00024 5.39543 6.00024 6.5V6.80859H18.0002V6.5C18.0002 5.39543 17.1048 4.5 16.0002 4.5Z" fill="currentColor"></path>
                                                                    <rect x="6.00024" y="12" width="12" height="7.5" rx="2" fill="currentColor"></rect>
                                                                    <path opacity="0.4" d="M19 6.80666H5C3.89543 6.80666 3 7.70209 3 8.80665V13.6928C3 14.7974 3.89543 15.6928 5 15.6928H17.625H19C20.1046 15.6928 21 14.7974 21 13.6928V8.80666C21 7.70209 20.1046 6.80666 19 6.80666Z" fill="currentColor"></path>
                                                                    </g>
                                                                    <defs>
                                                                    <clipPath id="notification_8">
                                                                    <rect width="24" height="24" fill="currentColor"></rect>
                                                                    </clipPath>
                                                                    </defs>
                                                                </svg>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <ul class="notification-list m-0 p-0">
                                <li class="d-flex align-items-center justify-content-between gap-3">
                                    <div class="user-img img-fluid">
                                        <img src="../social-app/assets/images/avatar/08.png" alt="story-img" class="rounded-circle avatar-40" loading="lazy" />
                                    </div>
                                    <div class="w-100">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                ...
                                                <div class="card-header-toolbar d-flex align-items-center">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                                                                <svg width="18" viewBox="0 0 24 24" class="me-3 icon-18" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                                    <g clip-path="url(#notification_9)">
                                                                    <path d="M16.0002 4.5H8.00024C6.89567 4.5 6.00024 5.39543 6.00024 6.5V6.80859H18.0002V6.5C18.0002 5.39543 17.1048 4.5 16.0002 4.5Z" fill="currentColor"></path>
                                                                    <rect x="6.00024" y="12" width="12" height="7.5" rx="2" fill="currentColor"></rect>
                                                                    <path opacity="0.4" d="M19 6.80666H5C3.89543 6.80666 3 7.70209 3 8.80665V13.6928C3 14.7974 3.89543 15.6928 5 15.6928H17.625H19C20.1046 15.6928 21 14.7974 21 13.6928V8.80666C21 7.70209 20.1046 6.80666 19 6.80666Z" fill="currentColor"></path>
                                                                    </g>
                                                                    <defs>
                                                                    <clipPath id="notification_9">
                                                                    <rect width="24" height="24" fill="currentColor"></rect>
                                                                    </clipPath>
                                                                    </defs>
                                                                </svg>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <ul class="notification-list m-0 p-0">
                                <li class="d-flex align-items-center justify-content-between gap-3">
                                    <div class="user-img img-fluid">
                                        <img src="../social-app/assets/images/avatar/12.png" alt="story-img" class="rounded-circle avatar-40" loading="lazy" />
                                    </div>
                                    <div class="w-100">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                ...
                                                <div class="card-header-toolbar d-flex align-items-center">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                                                                <svg width="18" viewBox="0 0 24 24" class="me-3 icon-18" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                                    <g clip-path="url(#notification_10)">
                                                                    <path d="M16.0002 4.5H8.00024C6.89567 4.5 6.00024 5.39543 6.00024 6.5V6.80859H18.0002V6.5C18.0002 5.39543 17.1048 4.5 16.0002 4.5Z" fill="currentColor"></path>
                                                                    <rect x="6.00024" y="12" width="12" height="7.5" rx="2" fill="currentColor"></rect>
                                                                    <path opacity="0.4" d="M19 6.80666H5C3.89543 6.80666 3 7.70209 3 8.80665V13.6928C3 14.7974 3.89543 15.6928 5 15.6928H17.625H19C20.1046 15.6928 21 14.7974 21 13.6928V8.80666C21 7.70209 20.1046 6.80666 19 6.80666Z" fill="currentColor"></path>
                                                                    </g>
                                                                    <defs>
                                                                    <clipPath id="notification_10">
                                                                    <rect width="24" height="24" fill="currentColor"></rect>
                                                                    </clipPath>
                                                                    </defs>
                                                                </svg>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <ul class="notification-list m-0 p-0">
                                <li class="d-flex align-items-center justify-content-between gap-3">
                                    <div class="user-img img-fluid">
                                        <img src="../social-app/assets/images/avatar/09.png" alt="story-img" class="rounded-circle avatar-40" loading="lazy" />
                                    </div>
                                    <div class="w-100">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                ...
                                                <div class="card-header-toolbar d-flex align-items-center">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                                                                <svg width="18" viewBox="0 0 24 24" class="me-3 icon-18" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                                    <g clip-path="url(#notification_11)">
                                                                    <path d="M16.0002 4.5H8.00024C6.89567 4.5 6.00024 5.39543 6.00024 6.5V6.80859H18.0002V6.5C18.0002 5.39543 17.1048 4.5 16.0002 4.5Z" fill="currentColor"></path>
                                                                    <rect x="6.00024" y="12" width="12" height="7.5" rx="2" fill="currentColor"></rect>
                                                                    <path opacity="0.4" d="M19 6.80666H5C3.89543 6.80666 3 7.70209 3 8.80665V13.6928C3 14.7974 3.89543 15.6928 5 15.6928H17.625H19C20.1046 15.6928 21 14.7974 21 13.6928V8.80666C21 7.70209 20.1046 6.80666 19 6.80666Z" fill="currentColor"></path>
                                                                    </g>
                                                                    <defs>
                                                                    <clipPath id="notification_11">
                                                                    <rect width="24" height="24" fill="currentColor"></rect>
                                                                    </clipPath>
                                                                    </defs>
                                                                </svg>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <ul class="notification-list m-0 p-0">
                                <li class="d-flex align-items-center justify-content-between gap-3">
                                    <div class="user-img img-fluid">
                                        <img src="../social-app/assets/images/avatar/10.png" alt="story-img" class="rounded-circle avatar-40" loading="lazy" />
                                    </div>
                                    <div class="w-100">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                ...
                                                <div class="card-header-toolbar d-flex align-items-center">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                                                                <svg width="18" viewBox="0 0 24 24" class="me-3 icon-18" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                                    <g clip-path="url(#notification_12)">
                                                                    <path d="M16.0002 4.5H8.00024C6.89567 4.5 6.00024 5.39543 6.00024 6.5V6.80859H18.0002V6.5C18.0002 5.39543 17.1048 4.5 16.0002 4.5Z" fill="currentColor"></path>
                                                                    <rect x="6.00024" y="12" width="12" height="7.5" rx="2" fill="currentColor"></rect>
                                                                    <path opacity="0.4" d="M19 6.80666H5C3.89543 6.80666 3 7.70209 3 8.80665V13.6928C3 14.7974 3.89543 15.6928 5 15.6928H17.625H19C20.1046 15.6928 21 14.7974 21 13.6928V8.80666C21 7.70209 20.1046 6.80666 19 6.80666Z" fill="currentColor"></path>
                                                                    </g>
                                                                    <defs>
                                                                    <clipPath id="notification_12">
                                                                    <rect width="24" height="24" fill="currentColor"></rect>
                                                                    </clipPath>
                                                                    </defs>
                                                                </svg>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <ul class="notification-list m-0 p-0">
                                <li class="d-flex align-items-center justify-content-between gap-3">
                                    <div class="user-img img-fluid">
                                        <img src="../social-app/assets/images/avatar/13.png" alt="story-img" class="rounded-circle avatar-40" loading="lazy" />
                                    </div>
                                    <div class="w-100">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                ...
                                                <div class="card-header-toolbar d-flex align-items-center">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                                                                <svg width="18" viewBox="0 0 24 24" class="me-3 icon-18" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                                    <g clip-path="url(#notification_13)">
                                                                    <path d="M16.0002 4.5H8.00024C6.89567 4.5 6.00024 5.39543 6.00024 6.5V6.80859H18.0002V6.5C18.0002 5.39543 17.1048 4.5 16.0002 4.5Z" fill="currentColor"></path>
                                                                    <rect x="6.00024" y="12" width="12" height="7.5" rx="2" fill="currentColor"></rect>
                                                                    <path opacity="0.4" d="M19 6.80666H5C3.89543 6.80666 3 7.70209 3 8.80665V13.6928C3 14.7974 3.89543 15.6928 5 15.6928H17.625H19C20.1046 15.6928 21 14.7974 21 13.6928V8.80666C21 7.70209 20.1046 6.80666 19 6.80666Z" fill="currentColor"></path>
                                                                    </g>
                                                                    <defs>
                                                                    <clipPath id="notification_13">
                                                                    <rect width="24" height="24" fill="currentColor"></rect>
                                                                    </clipPath>
                                                                    </defs>
                                                                </svg>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <ul class="notification-list m-0 p-0">
                                <li class="d-flex align-items-center justify-content-between gap-3">
                                    <div class="user-img img-fluid">
                                        <img src="../social-app/assets/images/avatar/14.png" alt="story-img" class="rounded-circle avatar-40" loading="lazy" />
                                    </div>
                                    <div class="w-100">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                ...
                                                <div class="card-header-toolbar d-flex align-items-center">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                                                                <svg width="18" viewBox="0 0 24 24" class="me-3 icon-18" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                                    <g clip-path="url(#notification_14)">
                                                                    <path d="M16.0002 4.5H8.00024C6.89567 4.5 6.00024 5.39543 6.00024 6.5V6.80859H18.0002V6.5C18.0002 5.39543 17.1048 4.5 16.0002 4.5Z" fill="currentColor"></path>
                                                                    <rect x="6.00024" y="12" width="12" height="7.5" rx="2" fill="currentColor"></rect>
                                                                    <path opacity="0.4" d="M19 6.80666H5C3.89543 6.80666 3 7.70209 3 8.80665V13.6928C3 14.7974 3.89543 15.6928 5 15.6928H17.625H19C20.1046 15.6928 21 14.7974 21 13.6928V8.80666C21 7.70209 20.1046 6.80666 19 6.80666Z" fill="currentColor"></path>
                                                                    </g>
                                                                    <defs>
                                                                    <clipPath id="notification_14">
                                                                    <rect width="24" height="24" fill="currentColor"></rect>
                                                                    </clipPath>
                                                                    </defs>
                                                                </svg>

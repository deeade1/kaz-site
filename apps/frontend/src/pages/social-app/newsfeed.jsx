        ...
        <div class="row">
                    ...
                    <div class="sidebar__inner">
                        <div class="card">
                            <div class="card-header d-flex align-items-center justify-content-between pb-3">
                                ...
                                <a class="text-body" href="javascript:void(0)">See all</a>
                            </div>
                            <div class="card-body">
                                <h5 class="mb-3">Stories About You</h5>
                                <div class="d-flex align-items-center mb-4 gap-3">
                                    <img src="../social-app/assets/images/avatar/31.png" class="img-fluid avatar-48 rounded-circle" alt="profile-image" />
                                    <div>
                                        <p class="mb-0">Mentions</p>
                                        <small>2 stories mention you</small>
                                    </div>
                                </div>
                                <h5 class="mb-4">New</h5>
                                <div class="iq-social-user-details">
                                    <div class="d-flex justify-content-center gap-3">
                                        <img src="../social-app/assets/images/avatar/01.png" class="img-fluid avatar-48 rounded-circle" alt="profile-image-1" loading="lazy" />
                                        <div class="d-flex align-items-center justify-content-between flex-grow-1">
                                            <div class="me-3">
                                                <h5>Sepid</h5>
                                                <small class="text-ellipsis short-1">Liked Your Photo</small>
                                            </div>
                                                <img src="../social-app/assets/images/newsfeed/06.png" class="img-fluid avatar-40 rounded object-contain" alt="profile-image" loading="lazy" />
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-center gap-3">
                                        <img src="../social-app/assets/images/avatar/09.png" class="img-fluid avatar-48 rounded-circle" alt="profile-image-1" loading="lazy" />
                                        <div class="d-flex align-items-center justify-content-between flex-grow-1">
                                            <div class="me-3">
                                                <h5>Rokni</h5>
                                                <small class="text-ellipsis short-1">Started Following You</small>
                                            </div>
                                            <div>
                                    ...
                                    <div class="d-flex justify-content-center gap-3">
                                        <img src="../social-app/assets/images/avatar/15.png" class="img-fluid avatar-48 rounded-circle" alt="profile-image-1" loading="lazy" />
                                        <div class="d-flex align-items-center justify-content-between flex-grow-1">
                                            <div class="me-3">
                                                <h5>Arman</h5>
                                                <small class="text-ellipsis short-1">Liked Your Photo</small>
                                            </div>
                                                <img src="../social-app/assets/images/newsfeed/05.png" class="img-fluid avatar-40 rounded object-contain" alt="profile-image" loading="lazy" />
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-center gap-3">
                                        <img src="../social-app/assets/images/avatar/23.png" class="img-fluid avatar-48 rounded-circle" alt="profile-image-1" loading="lazy" />
                                        <div class="d-flex align-items-center justify-content-between flex-grow-1">
                                            <div class="me-3">
                                                <h5>Medra</h5>
                                                <small class="text-ellipsis short-1">Started Following You</small>
                                    ...
                                    <div class="d-flex justify-content-center gap-3">
                                        <img src="../social-app/assets/images/avatar/26.png" class="img-fluid avatar-48 rounded-circle" alt="profile-image-1" loading="lazy" />
                                        <div class="d-flex align-items-center justify-content-between flex-grow-1">
                                            <div class="me-3">
                                                <h5>Afshin</h5>
                                                <small class="text-ellipsis short-1">Liked Your Photo</small>
                                            </div>
                                                <img src="../social-app/assets/images/newsfeed/07.png" class="img-fluid avatar-40 rounded object-contain" alt="profile-image" loading="lazy" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between flex-grow-1">
                                    ...
                                    <div class="btn btn-sm btn-primary-subtle">Website</div>
                                    <div class="btn btn-sm btn-primary-subtle">Product</div>
                                    </div>
                                </div>
                                <div class="iq-grid-explore d-grid mt-3">
                                    <a class="iq-item-col-end rounded" data-fslightbox="gallery" href="../social-app/assets/images/newsfeed/03.png">
                                        <img src="../social-app/assets/images/newsfeed/03.png" class="img-fluid rounded" alt="profile-image" loading="lazy" />
                                    </a>
                                    <a class="iq-item-row-end rounded" data-fslightbox="gallery" href="../social-app/assets/images/newsfeed/11.png">
                                        <img src="../social-app/assets/images/newsfeed/08.png" class="img-fluid rounded" alt="profile-image" loading="lazy" />
                                    </a>
                                    <a class="iq-item-row-end rounded" data-fslightbox="gallery" href="../social-app/assets/images/newsfeed/04.png">
                                        <img src="../social-app/assets/images/newsfeed/09.png" class="img-fluid rounded" alt="profile-image" loading="lazy" />
                                    </a>
                                    <a class="iq-item-row-end rounded" data-fslightbox="gallery" href="../social-app/assets/images/newsfeed/09.png">
                                        <img src="../social-app/assets/images/newsfeed/10.png" class="img-fluid rounded" alt="profile-image" loading="lazy" />
                                    </a>
                                    <a class="iq-item-row-end rounded" data-fslightbox="gallery" href="../social-app/assets/images/newsfeed/10.png">
                                        <img src="../social-app/assets/images/newsfeed/11.png" class="img-fluid rounded" alt="profile-image" loading="lazy" />
                                    </a>
                                    <a class="iq-item-col-end rounded" data-fslightbox="gallery" href="../social-app/assets/images/newsfeed/02.png">
                                        <img src="../social-app/assets/images/newsfeed/02.png" class="img-fluid rounded" alt="profile-image" loading="lazy" />
                                    </a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-xl-6 col-lg-6">
                <div class="card ">
                    ...
                    <div class="card-body">
                    <div id="stories" class="storiesWrapper d-flex justify-content-around stories user-icon carousel snapgram "><div class="story " data-id="yourstory" data-photo="../social-app/assets/images/avatar/01.png" data-last-updated="1717533297.371">
                    <a class="item-link" href="">
                        <span class="item-preview">
                        <img lazy="eager" src="../social-app/assets/images/avatar/01.png" />
                        </span>
                        <span class="info" itemprop="author" itemscope="" itemtype="http://schema.org/Person">
                        <strong class="name" itemprop="name">Your Story</strong>
                        <span class="time"></span>
                        </span>
                    </a>
                    
                    <ul class="items"><li class="" data-id="yourstory-1"><a href="https://raw.githubusercontent.com/ramon82/assets/master/zuck.js/stories/1.jpg" data-link="" data-linktext="" data-time="1717533297.371" data-type="photo" data-length="3">
                            <img loading="auto" src="https://raw.githubusercontent.com/ramon82/assets/master/zuck.js/stories/1.jpg" />
                        </a></li><li class="" data-id="yourstory-12"><a href="https://raw.githubusercontent.com/ramon82/assets/master/zuck.js/stories/2.mp4" data-link="" data-linktext="" data-time="1717533297.371" data-type="video" data-length="">
                            <img loading="auto" src="https://raw.githubusercontent.com/ramon82/assets/master/zuck.js/stories/2.jpg" />
                        </a></li></ul>
                    </div><div class="story " data-id="ali" data-photo="../social-app/assets/images/avatar/14.png" data-last-updated="1717533297.371">
                    <a class="item-link" href="">
                        <span class="item-preview">
                        <img lazy="eager" src="../social-app/assets/images/avatar/14.png" />
                        </span>
                        <span class="info" itemprop="author" itemscope="" itemtype="http://schema.org/Person">
                        <strong class="name" itemprop="name">Ali</strong>
                        <span class="time"></span>
                        </span>
                    </a>
                    
                    <ul class="items"><li class="" data-id="ali-1"><a href="https://raw.githubusercontent.com/ramon82/assets/master/zuck.js/stories/4.mp4" data-link="" data-linktext="" data-time="1717533297.371" data-type="video" data-length="">
                            <img loading="auto" src="https://raw.githubusercontent.com/ramon82/assets/master/zuck.js/stories/4.jpg" />
                        </a></li><li class="" data-id="ali-2"><a href="https://raw.githubusercontent.com/ramon82/assets/master/zuck.js/stories/5.jpg" data-link="" data-linktext="" data-time="1717533297.371" data-type="photo" data-length="3">
                            <img loading="auto" src="https://raw.githubusercontent.com/ramon82/assets/master/zuck.js/stories/5.jpg" />
                        </a></li><li class="" data-id="ali-3"><a href="https://raw.githubusercontent.com/ramon82/assets/master/zuck.js/stories/3.png" data-link="https://ramon.codes" data-linktext="Visit my Portfolio" data-time="1717533297.371" data-type="photo" data-length="3">
                            <img loading="auto" src="https://raw.githubusercontent.com/ramon82/assets/master/zuck.js/stories/3.png" />
                        </a></li></ul>
                    </div><div class="story " data-id="ammy" data-photo="../social-app/assets/images/avatar/15.png" data-last-updated="1717533297.371">
                    <a class="item-link" href="">
                        <span class="item-preview">
                        <img lazy="eager" src="../social-app/assets/images/avatar/15.png" />
                        </span>
                        <span class="info" itemprop="author" itemscope="" itemtype="http://schema.org/Person">
                        <strong class="name" itemprop="name">Ammy</strong>
                        <span class="time"></span>
                        </span>
                    </a>
                    
                    <ul class="items"><li class="" data-id="ammy-1">
                        <a href="https://raw.githubusercontent.com/ramon82/assets/master/zuck.js/stories/6.jpg" data-link="" data-linktext="" data-time="1717533297.371" data-type="photo" data-length="5">
                            <img loading="auto" src="https://raw.githubusercontent.com/ramon82/assets/master/zuck.js/stories/6.jpg" />
                        </a>
                        </li>
                        <li class="" data-id="ammy-2">
                            <a href="https://raw.githubusercontent.com/ramon82/assets/master/zuck.js/stories/7.jpg" data-link="http://ladygaga.com" data-linktext="" data-time="1717533297.371" data-type="photo" data-length="3">
                            <img loading="auto" src="https://raw.githubusercontent.com/ramon82/assets/master/zuck.js/stories/7.jpg" />
                        </a></li></ul>
                    </div><div class="story " data-id="roger-1" data-photo="../social-app/assets/images/avatar/16.png" data-last-updated="1717533297.371">
                    <a class="item-link" href="">
                        <span class="item-preview">
                        <img lazy="eager" src="../social-app/assets/images/avatar/16.png" />
                        </span>
                        <span class="info" itemprop="author" itemscope="" itemtype="http://schema.org/Person">
                        <strong class="name" itemprop="name">Roger</strong>
                        <span class="time"></span>
                        </span>
                    </a>
                    
                    <ul class="items"><li class="" data-id="roger-1">
                        <a href="https://raw.githubusercontent.com/ramon82/assets/master/zuck.js/stories/8.jpg" data-link="" data-linktext="" data-time="1717533297.371" data-type="photo" data-length="5">
                            <img loading="auto" src="https://raw.githubusercontent.com/ramon82/assets/master/zuck.js/stories/8.jpg" />
                        </a></li></ul>
                    </div><div class="story " data-id="justin" data-photo="../social-app/assets/images/avatar/17.png" data-last-updated="1717533297.371">
                    <a class="item-link" href="">
                        <span class="item-preview">
                        <img lazy="eager" src="../social-app/assets/images/avatar/17.png" />
                        </span>
                        <span class="info" itemprop="author" itemscope="" itemtype="http://schema.org/Person">
                        <strong class="name" itemprop="name">Justin</strong>
                        <span class="time"></span>
                        </span>
                    </a>
                    
                    <ul class="items"><li class="" data-id="justin-1">
                        <a href="https://raw.githubusercontent.com/ramon82/assets/master/zuck.js/stories/9.jpg" data-link="" data-linktext="" data-time="1717533297.371" data-type="photo" data-length="10">
                            <img loading="auto" src="https://raw.githubusercontent.com/ramon82/assets/master/zuck.js/stories/9.jpg" />
                        </a></li></ul>
                    </div><div class="story " data-id="roy" data-photo="../social-app/assets/images/avatar/18.png" data-last-updated="1717533297.371">
                    <a class="item-link" href="">
                        <span class="item-preview">
                        <img lazy="eager" src="../social-app/assets/images/avatar/18.png" />
                        </span>
                        <span class="info" itemprop="author" itemscope="" itemtype="http://schema.org/Person">
                        <strong class="name" itemprop="name">Roy</strong>
                        <span class="time"></span>
                        </span>
                    </a>
                    
                    <ul class="items"><li class="" data-id="roy-1"><a href="https://raw.githubusercontent.com/ramon82/assets/master/zuck.js/stories/9.jpg" data-link="" data-linktext="" data-time="1717533297.371" data-type="photo" data-length="10">
                            <img loading="auto" src="https://raw.githubusercontent.com/ramon82/assets/master/zuck.js/stories/9.jpg" />
                        </a></li></ul>
                    </div><div class="story " data-id="johan" data-photo="../social-app/assets/images/avatar/19.png" data-last-updated="1717533297.371">
                    <a class="item-link" href="">
                        <span class="item-preview">
                        <img lazy="eager" src="../social-app/assets/images/avatar/19.png" />
                        </span>
                        <span class="info" itemprop="author" itemscope="" itemtype="http://schema.org/Person">
                        <strong class="name" itemprop="name">Johan</strong>
                        <span class="time"></span>
                        </span>
                    </a>
                    
                    <ul class="items"><li class="" data-id="johan-1"><a href="https://raw.githubusercontent.com/ramon82/assets/master/zuck.js/stories/9.jpg" data-link="" data-linktext="" data-time="1717533297.371" data-type="photo" data-length="10">
                            <img loading="auto" src="https://raw.githubusercontent.com/ramon82/assets/master/zuck.js/stories/9.jpg" />
                        </a></li></ul>
                    </div><div class="story " data-id="sado" data-photo="../social-app/assets/images/avatar/20.png" data-last-updated="1717533297.371">
                    <a class="item-link" href="">
                        <span class="item-preview">
                        <img lazy="eager" src="../social-app/assets/images/avatar/20.png" />
                        </span>
                        <span class="info" itemprop="author" itemscope="" itemtype="http://schema.org/Person">
                        <strong class="name" itemprop="name">Sado</strong>
                        <span class="time"></span>
                        </span>
                    </a>
                    
                    <ul class="items"><li class="" data-id="sado-1"><a href="https://raw.githubusercontent.com/ramon82/assets/master/zuck.js/stories/9.jpg" data-link="" data-linktext="" data-time="1717533297.371" data-type="photo" data-length="10">
                            <img loading="auto" src="https://raw.githubusercontent.com/ramon82/assets/master/zuck.js/stories/9.jpg" />
                        </a></li></ul>
                    </div></div>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="user-post">
                            <img src="../social-app/assets/images/app/01.png" class="img-fluid rounded" alt="post-image" data-bs-toggle="modal" data-bs-target="#image-modal" role="button" loading="lazy" />
                        </div>
                ...
                <div class="card">
                    <div class="card-header d-flex  justify-content-between">
                        <div class="header-title">
                            <div class="d-flex justify-content-center flex-wrap gap-3">
                                <img class="img-fluid rounded-circle p-1 border border-2 border-primary border-dotted avatar-50" src="../social-app/assets/images/avatar/24.png" alt="profile-img" loading="lazy" />
                                <div class="media-support-info">
                                    <div class="d-flex align-items-center mb-2 gap-2">
                            ...
                            <div class="d-flex flex-wrap justify-content-between align-items-center">
                                <div class="d-flex align-items-center gap-3">
                                    <div class="total-like-block">
                                        <div class="dropdown">
                                            <a href="javascript:void(0);" class="text-body d-flex align-items-center gap-2" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                ...
                                                <span class=" d-none d-sm-block">15 Likes</span>
                                            </a>
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="javascript:void(0);">Max Emum</a>
                                                <a class="dropdown-item" href="javascript:void(0);">Bill Yerds</a>
                                    ...
                                    <div class="total-comment-block">
                                        <div class="dropdown">
                                            <a href="javascript:void(0);" class="text-body d-flex align-items-center gap-2" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                ...
                                                <span class=" d-none d-sm-block">20 Comments</span>
                                            </a>
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="javascript:void(0);">Max Emum</a>
                                                <a class="dropdown-item" href="javascript:void(0);">Bill Yerds</a>
                                    ...
                                    <a href="javascript:void(0);" class="text-body d-flex align-items-center gap-2" data-bs-toggle="offcanvas" data-bs-target="#share-btn" aria-controls="share-btn">
                                        ...
                                        <span class=" d-none d-sm-block">04 Share</span>
                                    </a>
                                </div>
                                <a href="javascript:void(0);" class="d-flex align-items-center gap-2 text-body save">
                                    <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <nav class="tab-bottom-bordered">
                                <div class="mb-0 nav nav-tabs flex-nowrap justify-content-between" id="nav-tab" role="tablist">
                                    <button class="nav-link active" id="pills-activeorders-tab1" data-bs-toggle="pill" data-bs-target="#pills-activeorders" role="tab" aria-controls="pills-activeorders" aria-selected="true">
                                        ...
                                        <span class="iq-socail-message-tab-icon" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Primary" data-bs-original-title="Primary">
                                            <svg class="icon-24" width="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <button class="nav-link" id="pills-cancelledorders-tab1" data-bs-toggle="pill" data-bs-target="#pills-cancelledorders" role="tab" aria-controls="pills-cancelledorders" aria-selected="false" tabindex="-1">
                                        <span class="iq-socail-message-tab-text">
                                            Recent
                                        </span>
                                        <span class="iq-socail-message-tab-icon" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="General" data-bs-original-title="General">
                                            <svg class="icon-24" width="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <button class="nav-link" id="pills-mytrades-tab1" data-bs-toggle="pill" data-bs-target="#pills-mytrades" role="tab" aria-controls="pills-mytrades" aria-selected="false" tabindex="-1">
                                        <span class="iq-socail-message-tab-text">
                                            New
                                        </span>
                                        <span class="iq-socail-message-tab-icon" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Requests" data-bs-original-title="Requests">
                                            <svg class="icon-24" width="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="tab-content iq-tab-fade-up" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-activeorders" role="tabpanel" aria-labelledby="pills-activeorders-tab1">
                                <div class="tabs-panel">
                                    <ul class="list-unstyled mb-0">
                                        <li class="pt-3">
                                            <div class="d-flex justify-content-center gap-3">
                                                <img src="../social-app/assets/images/avatar/11.png" class="img-fluid avatar-48 rounded-circle" alt="profile-image-1" loading="lazy" />
                                                <div class="d-flex align-items-center justify-content-between flex-grow-1">
                                                    <div class="me-3">
                                                        <h5>Arman Rokni</h5>
                                                        <small class="text-ellipsis short-1">Active 30m</small>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="pt-3">
                                            <div class="d-flex justify-content-center gap-3">
                                                <img src="../social-app/assets/images/avatar/12.png" class="img-fluid avatar-48 rounded-circle" alt="profile-image-1" loading="lazy" />
                                                <div class="d-flex align-items-center justify-content-between flex-grow-1">
                                                    <div class="me-3">
                                                        <h5>MD Alidoost</h5>
                                                        <small class="text-ellipsis short-1">Active 30m</small>
                                        ...
                                        <li class="pt-3">
                                            <div class="d-flex justify-content-center gap-3">
                                                <img src="../social-app/assets/images/avatar/14.png" class="img-fluid avatar-48 rounded-circle" alt="profile-image-1" loading="lazy" />
                                                <div class="d-flex align-items-center justify-content-between flex-grow-1">
                                                    <div class="me-3">
                                                        <h5>Salman Shaha</h5>
                                                        <small class="text-ellipsis short-1">Active 30m</small>
                                        ...
                                        <li class="pt-3">
                                            <div class="d-flex justify-content-center gap-3">
                                                <img src="../social-app/assets/images/avatar/10.png" class="img-fluid avatar-48 rounded-circle" alt="profile-image-1" loading="lazy" />
                                                <div class="d-flex align-items-center justify-content-between flex-grow-1">
                                                    <div class="me-3">
                                                        <h5>Goutham</h5>
                                                        <small class="text-ellipsis short-1">Active 30m</small>
                            ...
                            <div class="tab-pane fade" id="pills-cancelledorders" role="tabpanel" aria-labelledby="pills-cancelledorders-tab1">
                                <div class="tabs-panel">
                                    <ul class="list-unstyled mb-0">
                                        <li class="pt-3">
                                            <div class="d-flex justify-content-center gap-3">
                            ...
                            <div class="tab-pane fade" id="pills-mytrades" role="tabpanel" aria-labelledby="pills-mytrades-tab1">
                                <div class="tabs-panel">
                                    <ul class="list-unstyled mb-0">
                                        <li class="pt-3">
                                            <div class="d-flex justify-content-center gap-3">
                        ...
                        <div class="iq-social-user-details">
                            <div class="d-flex justify-content-center gap-3">
                                ...
                                <div class="d-flex align-items-center justify-content-between flex-grow-1">
                                    <div class="me-3">
                                        <h5>Vida Lakhani</h5>
                                        <small class="text-ellipsis short-1">Suggested For you</small>
                                    </div>
                                    <div>
                            ...
                            <div class="d-flex justify-content-center gap-3">
                                ...
                                <div class="d-flex align-items-center justify-content-between flex-grow-1">
                                    <div class="me-3">
                                        <h5>Salman Shaha</h5>
                                        <small class="text-ellipsis short-1">Followed By Mr. Ali</small>
                                    </div>
                                    <div>
                                        <button class="btn btn-icon btn-sm btn-primary rounded-pill">
                                            <span class="btn-inner">
                            ...
                            <div class="d-flex justify-content-center gap-3">
                                ...
                                <div class="d-flex align-items-center justify-content-between flex-grow-1">
                                    <div class="me-3">
                                        <h5>Afshin Rotni</h5>
                                        <small class="text-ellipsis short-1">Followed By Afshint</small>
                                    </div>
                                    <div>
                                        <button class="btn btn-icon btn-sm btn-primary rounded-pill">
                                            <span class="btn-inner">
                            ...
                            <div class="d-flex justify-content-center gap-3">
                                ...
                                <div class="d-flex align-items-center justify-content-between flex-grow-1">
                                    <div class="me-3">
                                        <h5>MD Ali</h5>
                                        <small class="text-ellipsis short-1">Followed By Vida</small>
                                    </div>
                                    <div>
                                        <button class="btn btn-icon btn-sm btn-primary rounded-pill">
                                            <span class="btn-inner">

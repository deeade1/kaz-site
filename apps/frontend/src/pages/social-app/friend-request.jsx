        ...
        <div class="col-sm-12">
            ...
            <div class="card-body">
                <ul class="request-list list-inline m-0 p-0">
                    ...
                    <li class="d-flex align-items-center gap-3 justify-content-between border-bottom mb-3 pb-3 flex-column flex-md-row">
                        <div class="user-img img-fluid flex-shrink-0">
                            <img src="../social-app/assets/images/avatar/08.png" alt="story-img" class="rounded-circle avatar-48" loading="lazy" />
                        </div>
                        <div class="d-flex align-items-center justify-content-between w-100 flex-column flex-md-row">
                            <div class="">
                                <h6>Chris P. Cream</h6>
                    ...
                    <li class="d-flex align-items-center gap-3 justify-content-between border-bottom mb-3 pb-3 flex-column flex-md-row">
                        <div class="user-img img-fluid flex-shrink-0">
                            <img src="../social-app/assets/images/avatar/09.png" alt="story-img" class="rounded-circle avatar-48" loading="lazy" />
                        </div>
                        <div class="d-flex align-items-center justify-content-between w-100 flex-column flex-md-row">
                            <div class="">
                                <h6>Paul Misunda</h6>
                    ...
                    <li class="d-flex align-items-center gap-3 justify-content-between border-bottom mb-3 pb-3 flex-column flex-md-row">
                        <div class="user-img img-fluid flex-shrink-0">
                            <img src="../social-app/assets/images/avatar/10.png" alt="story-img" class="rounded-circle avatar-48" loading="lazy" />
                        </div>
                        <div class="d-flex align-items-center justify-content-between w-100 flex-column flex-md-row">
                            <div class="">
            ...
            <div class="card-body">
                <ul class="request-list m-0 p-0">
                    ...
                    <li class="d-flex align-items-center gap-3 justify-content-between  flex-column flex-md-row">
                        <div class="user-img img-fluid flex-shrink-0">
                            <img src="../social-app/assets/images/avatar/11.png" alt="story-img" class="rounded-circle avatar-48" loading="lazy" />
                        </div>
                        <div class="d-flex align-items-center justify-content-between w-100 flex-column flex-md-row">
                            <div class="">

...
const SignUp = () => {
  ...
  const { onChange, onSubmit, values, formRef, isValidated, errors, setErrors } = useForm(signUpCallback, {
    contact: '',
    password: ''
  });
              ...
              <Col md="10">
                <Card className="card-transparent shadow-none d-flex justify-content-center mb-0 auth-card">
                  <Card.Body>
                    ...
                    <p className="text-center">Create your Royal Foam account.</p>
                    <Form ref={formRef} noValidate className={`needs-validation ${isValidated ? 'was-validated' : ''}`} onSubmit={onSubmit}>
                      ...
                      <p className="mt-3 text-center">
                        Don’t have an account? <Link to="/auth/sign-in" className="text-underline">Click here to sign in.</Link>
                      </p>
                    </Form>
                  </Card.Body>
                </Card>
